...
- ⚙️ **Settings**: Feature toggles, preferences, configurations
- 📝 **Forms**: Validation states, submission states, field visibility
- 🎨 **Themes**: Dark/light mode, UI variants
- 📱 **Responsive**: Mobile menu states, collapsible content
- 🔄 **Loading**: Request states, progress indicators
