...
### State Management
- **[useCountdown](/docs/hooks/use-countdown)** - Timer management with start/pause/reset controls
- **[useLocalStorage](/docs/hooks/use-local-storage)** - Persistent localStorage management with type safety

### UI & Interaction
- **[useClickOutside](/docs/hooks/use-click-outside)** - Detect clicks outside specific elements
- **[useIsMobile](/docs/hooks/use-is-mobile)** - Device detection for responsive behavior with ResizeObserver

### Network & Communication
- **[usePing](/docs/hooks/use-ping)** - Network connectivity and latency monitoring
