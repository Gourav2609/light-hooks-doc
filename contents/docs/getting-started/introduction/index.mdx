...
<Note title="Get Started">
  Ready to enhance your React app? Install light-hooks with `npm install
  light-hooks` and explore our [GitHub
  repository](https://github.com/Gourav2609/light-hooks) for the latest updates
  and contributions!
</Note>
